...
/**
 * Class to store attributes for busbar section.
 * Also generates SQL queries to create table and insert data into the table
 * 
 * @author Alvin Lee
 *
 */
public class BusbarSection extends BaseCimClass{
	...
	public BusbarSection(Element element) {
		parseRDF(element);
	...
	public String createTable() {
		return BUSBAR_ + " (" + RDF_ID_ + " " + STRING + " NOT NULL, " + NAME_ + " " + STRING + ", "
	...
	public String insertTable() {
		...
		String command = BUSBAR_ + columnNames + ") " + values + ")"; 
	...
	public String getElement() { return BUSBAR_; }
